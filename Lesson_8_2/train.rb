...
class Train
  ...
  def validate!
    raise "Number can't be empty. Please try again." if number.empty?
    raise "Type can't be empty. Please try again." if type.empty?
    raise "Train type must be 'cargo' or 'passenger'. Please try again." if type != 'passenger' && @type != 'cargo'
